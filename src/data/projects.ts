...
export const projects: Project[] = [
  ...
  },
  {
    slug: "rl-snake-bot",
    title: "RL Snake Bot",
    tagline: "Deep Q-Network agent that learns to play Snake from scratch",
    description:
      "A full-stack Reinforcement Learning project implementing a DQN agent for Snake using PyTorch and Gymnasium. The agent learns purely through trial and error, reaching a best score of 58. Includes MLflow experiment tracking, FastAPI inference API, and a React frontend with live Q-value visualization.",
    highlights: [
      "DQN agent trained from scratch — best score 58 after 1000 episodes",
      "Custom Gymnasium environment wrapping a Pygame Snake game",
      "MLflow experiment tracking with hyperparameter logging and model artifacts",
      "FastAPI REST API serving trained model with /predict endpoint",
      "React + TypeScript frontend showing live gameplay and Q-value bars",
    ...
    github: "https://github.com/M-Nusrat-Ullah/rl-snake-bot",
    image: "/screenshots/rl-snake-demo.gif",
    gallery: [
      "/screenshots/training_progress.png",
      "/screenshots/rl-snake-demo.gif",
    ],
    featured: false,
  },
  {
